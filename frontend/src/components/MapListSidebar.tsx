...
export const MapListSidebar: React.FC<MapListSidebarProps> = ({
    ...
    return (
        <div className="fixed top-0 right-0 w-[320px] min-h-[200px] max-h-[80%] bg-zinc-900/50 backdrop-blur-sm border-t border-zinc-800/50 flex flex-col rounded-tl-lg z-50">
