...
import { Upload, Image, X, Download, Trash2 } from 'lucide-react';
        ...
        <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900">
            <div className="max-w-7xl mx-auto p-6">
                ...
                <Dialog open={isNoteDialogOpen} onOpenChange={setIsNoteDialogOpen}>
                    <DialogContent className="bg-white dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700 max-w-6xl">
                        <DialogHeader>
