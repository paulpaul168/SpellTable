...
def main() -> None:
    ...
    defs += [
        R(
            ...
            "200 gp, 5 days. Prereq Cellar Cheap. Valuation +1; +15 gp/tenday wholesale beer income; half cellar; brewing downtime.",
            200,
            5,
            [
                {"kind": "valuation_bonus", "amount": 1},
        ...
        R(
            ...
            "450 gp, 5 days. Valuation +3; +35 gp/tenday wholesale beer income.",
            450,
            5,
            [
                {"kind": "valuation_bonus", "amount": 3},
                {"kind": "fixed_income_gp_per_tenday", "amount": 35},
            ],
            so(),
            group="tavern_structure",
        ),
        R(
            ...
            "600 gp, 5 days. Valuation +5; +55 gp/tenday wholesale beer income.",
            600,
            5,
            [
                {"kind": "valuation_bonus", "amount": 5},
                {"kind": "fixed_income_gp_per_tenday", "amount": 55},
            ],
            so(),
            group="tavern_structure",
        ),
        R(
            ...
            "400 gp, 5 days. Prereq Cellar Cheap. Valuation +1; +15 gp/tenday wholesale spirit income.",
            400,
            5,
            [
                {"kind": "valuation_bonus", "amount": 1},
        ...
        R(
            ...
            "650 gp, 5 days. Valuation +3; +35 gp/tenday wholesale spirit income.",
            650,
            5,
            [
                {"kind": "valuation_bonus", "amount": 3},
        ...
        R(
            ...
            "800 gp, 5 days. Valuation +5; +55 gp/tenday wholesale spirit income.",
            800,
            5,
            [
                {"kind": "valuation_bonus", "amount": 5},
        ...
        R(
            "[Tavern] Winery — Cheap",
            "500 gp, 7 days. Prereq Cellar Moderate. Valuation +2; +22 gp/tenday wholesale wine income; vineyard; half cellar.",
            500,
            7,
            [
                {"kind": "valuation_bonus", "amount": 2},
                {"kind": "fixed_income_gp_per_tenday", "amount": 22},
            ],
            so(),
            group="tavern_structure",
        ),
        R(
            ...
            "750 gp, 7 days. Valuation +4; +48 gp/tenday wholesale wine income.",
            750,
            7,
            [
                {"kind": "valuation_bonus", "amount": 4},
                {"kind": "fixed_income_gp_per_tenday", "amount": 48},
            ],
            so(),
            group="tavern_structure",
        ),
        R(
            ...
            "1,200 gp, 7 days. Valuation +6; +72 gp/tenday wholesale wine income.",
            1200,
            7,
            [
                {"kind": "valuation_bonus", "amount": 6},
                {"kind": "fixed_income_gp_per_tenday", "amount": 72},
            ],
            so(),
            group="tavern_structure",
        ),
        R(
            ...
            "650 gp, 10 days. Prereq Cellar w/ beer space. Valuation +4; +20 gp/tenday draft throughput & festival spillover. Beer Festival downtime.",
            650,
            10,
            [
                {"kind": "valuation_bonus", "amount": 4},
                {"kind": "fixed_income_gp_per_tenday", "amount": 20},
            ],
            so(),
            group="tavern_structure",
        ),
        R(
            "[Tavern] Beer Garden",
            "200 gp, 3 days. Prereq Taproom Cheap. Valuation +2; +12 gp/tenday outdoor food & drink (seasonal). Outdoor BBQ; not winter.",
            200,
            3,
            [
                {"kind": "valuation_bonus", "amount": 2},
                {"kind": "fixed_income_gp_per_tenday", "amount": 12},
            ],
            so(),
            group="tavern_structure",
        ),
